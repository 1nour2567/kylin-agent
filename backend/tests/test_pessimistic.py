...
def test_t2_structured_tool_call_with_dangerous_path():
    """T2 structural validation catches dangerous param values in DANGEROUS_PATHS."""
    engine = ConstraintEngine()
    # /dev/sda1 matches DANGEROUS_PATHS prefix "/dev/sd" — cross-platform safe
    result = engine.validate("cat", "balanced", params={"path": "/dev/sda1"})
